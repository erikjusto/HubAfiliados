      ...
      <div className="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden transition-all duration-300 hover:shadow-md">
        <div className="p-6 md:p-8 bg-gradient-to-r from-blue-50 to-white">
          ...
          <p className="text-slate-500 mb-6 max-w-2xl text-sm">
            Cole o link de afiliado ou link de recomendações do Mercado Livre. O sistema irá extrair os dados do card de produto (Poly-Card) automaticamente.
          </p>
            ...
            <div className="flex flex-col md:flex-row gap-3">
              <div className="flex-1 relative">
                ...
                <input
                  ...
                  placeholder="https://www.mercadolivre.com.br/perfil/afiliado/..."
                  className="block w-full pl-11 pr-4 py-4 rounded-xl border-2 border-slate-100 focus:border-blue-400 focus:ring-0 outline-none transition-all placeholder:text-slate-300 text-slate-700 shadow-sm"
                />
              </div>
              <button
                type="submit"
