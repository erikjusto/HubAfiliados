            ...
            <div className="flex items-start justify-between gap-4 mb-2">
              {isEditing ? (
                <input
                  ...
                  className="text-2xl font-bold text-slate-800 leading-tight w-full border-b-2 border-blue-400 outline-none bg-blue-50/50 px-2 py-1 rounded"
                />
              ) : (
                <h2 className="text-2xl font-bold text-slate-800 leading-tight">{editedData.name}</h2>
              )}
              <button 
                onClick={onCancel}
                disabled={loading}
            ...
            <div>
              <div className="flex items-center justify-between mb-2">
                ...
                <button
                  ...
                  className="text-[10px] font-bold text-blue-600 hover:text-blue-700 bg-blue-50 px-2 py-1 rounded border border-blue-100 flex items-center gap-1 transition-all active:scale-95 disabled:opacity-50"
                >
                  {isGenerating ? (
                    <>
