...
const StorefrontTab: React.FC<StorefrontTabProps> = ({ history, onAdminClick, isLoading }) => {
  ...
  return (
    <div className="min-h-screen bg-[#ebebeb] -mx-4 -mt-6 md:-mx-8 md:-mt-8">
      ...
      <main className="max-w-7xl mx-auto px-4 md:px-8 pt-0 pb-12 -mt-12 relative z-10">
        <div className="flex flex-col lg:flex-row gap-8 items-start">
          {/* Sidebar Filters */}
          <aside className="hidden lg:block w-64 shrink-0 space-y-8 sticky top-[120px]" ref={productsRef}>
            <div>
            ...
            <div className="pt-6 border-t border-slate-200">
              <h3 className="font-bold text-slate-800 mb-4">Custo do frete</h3>
              <div className="flex items-center gap-2 text-sm text-green-600 font-semibold cursor-pointer">
